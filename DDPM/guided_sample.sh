...
# 128*128
SAMPLE_FLAGS="--log_dir ./save_sample_images/resnet101_soft3_jt1.0+mt0.5_gamma0.3_50000 --batch_size 16 --num_samples 50000 --timestep_respacing 250"
...
mpiexec -n 8 python scripts/classifier_sample.py --model_path "pretrained_models/128x128_diffusion.pt" $MODEL_FLAGS $CLASSIFIER_FLAGS $SAMPLE_FLAGS
